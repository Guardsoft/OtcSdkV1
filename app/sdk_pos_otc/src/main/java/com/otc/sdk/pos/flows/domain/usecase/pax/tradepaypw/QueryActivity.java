...
//                startActivity(intent);
            ...
            if ((magRet == 0) && (panDialog == null)) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        panDialog = new CustomAlertDialog(QueryActivity.this, CustomAlertDialog.SUCCESS_TYPE);
    ...
    private void startEmvTrans() {
        ...
        emv = new ImplEmv(QueryActivity.this, false);
       ...
       // emv = new ImplEmv(SwingCardActivity.this);
        ...
        if (ret == TransResult.EMV_ONLINE_APPROVED || ret == TransResult.EMV_OFFLINE_APPROVED || ret == TransResult.EMV_ONLINE_CARD_DENIED) {
            ...
            runOnUiThread(() -> {
                promptDialog = new CustomAlertDialog(QueryActivity.this, CustomAlertDialog.PROGRESS_TYPE);
    ...
    private void showErr(final int ret) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                final CustomAlertDialog dialog = new CustomAlertDialog(QueryActivity.this, CustomAlertDialog.ERROR_TYPE);
...
//        Log.e(TAG, "ClssPayWave setConfigParam diff = " + diff);
    ...
    private int startConlssPBOC(TransResult transResult) {
        ...
        emv = new ImplEmv(QueryActivity.this);
        emv.operation = "";
    ...
    private void toTradeResultActivity() {
        ...
        callback.retrieveList(this, trackData2_38, 1, 100, new QueryResponseHandler() {
            @Override
    ...
    private void toConsumeActitivy(int result, int cvmtype) {
        ...
        Intent intent = new Intent(QueryActivity.this, ConsumeActivity.class);
        intent.putExtra("amount", amount);
        intent.putExtra("pan", pan);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iDetectCard.putExtra("readType", (byte) 7);
