package com.otc.sdk.pax.a920.crypto.device;
...
import com.otc.sdk.pax.a920.local.Constants;
...
//***
    ...
    public static byte[] getKCV_TDK2(byte keyIndex) {
        IPed ped = OtcApplication.getDal().getPed(EPedType.INTERNAL);
        try {
            byte[] bytes_tdk = ped.getKCV(EPedKeyType.TDK, keyIndex, (byte) 0, byte_test);
            Log.i("getKCV_TDK:slot" + keyIndex, OtcApplication.getConvert().bcdToStr(bytes_tdk));
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public static boolean validaKeyDataPin(int indexData, int indexPin) {

        String testValue = "FaridGamarraFlorFaridGamarraFlor";
        ...
        try {
            ...
            byte [] result2 =  OtcApplication.getDal()
                    .getPed(EPedType.INTERNAL)
                    .calcAes(
                            (byte)indexPin,
                            initVector,
    ...
    public static boolean writeTAK(int tmkIndex, int takIndex, byte[] bytesTakSignature) {
        try {
            OtcApplication.getDal()
                    .getPed(EPedType.INTERNAL)
                    .writeKey(
